  ...
  return (
    <div>
      <div className="py-2 px-6">
        <h2 className="text-xl font-medium tracking-wide pb-2">
          Recent Generations
        </h2>

        <div className="p-3 bg-[#f0eeff] mt-2 rounded-lg flex flex-row items-center space-x-3">
          <div>
        ...
        <div className="p-3 bg-[#f0eeff] mt-2 rounded-lg flex flex-row items-center space-x-3">
          ...
          <div>
            ...
            <p className="text-gray-600 text-sm pt-0.5">Generated 2 days ago</p>
          </div>
        </div>
      </div>
    </div>
